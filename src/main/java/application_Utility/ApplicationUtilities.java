...
import property_utility.PropertyUtility_Code;




public  class ApplicationUtilities extends Baselibrary.BaseLibrary
{
	...
	public void openIB(WebDriver driver) {
		try {
			...
			String StrURLIB = PropertyUtility_Code.getdatafromfile("urlIB");
			driver.get(StrURLIB);
		} catch (Exception e) {
